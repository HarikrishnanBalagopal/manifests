+++
title = "Kubernetes Cluster on Classic Infra"
description = "Create your cluster on a classic compute, networking, and storage environment in IBM Cloud infrastructure"
weight = 20
aliases = ["/docs/prerequisites/classic/"]
+++
