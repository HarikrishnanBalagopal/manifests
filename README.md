...
| Notebook Controller | apps/jupyter/notebook-controller/upstream | [v1.8.0-rc.1](https://github.com/kubeflow/kubeflow/tree/v1.8.0-rc.1/components/notebook-controller/config) |
| PVC Viewer Controller | apps/pvcviewer-roller/upstream | [v1.8.0-rc.1](https://github.com/kubeflow/kubeflow/tree/v1.8.0-rc.1/components/pvcviewer-controller/config) |
| Tensorboard Controller | apps/tensorboard/tensorboard-controller/upstream | [v1.8.0-rc.1](https://github.com/kubeflow/kubeflow/tree/v1.8.0-rc.1/components/tensorboard-controller/config) |
| Central Dashboard | apps/centraldashboard/upstream | [v1.8.0-rc.1](https://github.com/kubeflow/kubeflow/tree/v1.8.0-rc.1/components/centraldashboard/manifests) |
| Profiles + KFAM | apps/profiles/upstream | [v1.8.0-rc.1](https://github.com/kubeflow/kubeflow/tree/v1.8.0-rc.1/components/profile-controller/config) |
| PodDefaults Webhook | apps/admission-webhook/upstream | [v1.8.0-rc.1](https://github.com/kubeflow/kubeflow/tree/v1.8.0-rc.1/components/admission-webhook/manifests) |
| Jupyter Web App | apps/jupyter/jupyter-web-app/upstream | [v1.8.0-rc.1](https://github.com/kubeflow/kubeflow/tree/v1.8.0-rc.1/components/crud-web-apps/jupyter/manifests) |
| Tensorboards Web App | apps/tensorboard/tensorboards-web-app/upstream | [v1.8.0-rc.1](https://github.com/kubeflow/kubeflow/tree/v1.8.0-rc.1/components/crud-web-apps/tensorboards/manifests) |
| Volumes Web App | apps/volumes-web-app/upstream | [v1.8.0-rc.1](https://github.com/kubeflow/kubeflow/tree/v1.8.0-rc.1/components/crud-web-apps/volumes/manifests) |
